...
const Room = () => {
  ...
  useEffect(() => {
    const fetchRoomDetails = async () => {
      try {
        ...
        const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/rooms/getRoomDetails`, { params: { roomId } });
  ...
  const handleLeaveRoom = () => {
    axios
      .post(`${process.env.REACT_APP_API_URL}/api/rooms/leave`, { roomId, userID })
      .then((response) => {
  ...
  const handleDeleteRoom = () => {
    axios
      .delete(`${process.env.REACT_APP_API_URL}/api/rooms/deleteRoom`, { data: { roomId } } )
      .then((response) => {
        navigate(`/home`); // Use navigate function to redirect
      })
      .catch((error) => {
  ...
  const startTournament = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_URL}/api/tournament/startTournament`, {  roomId  } )
      .then((response) => {
