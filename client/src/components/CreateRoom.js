...
const CreateRoom = () => {
  ...
  const handleCreateRoom = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_API_URL}/api/rooms/create`, { roomName, userName, userID })
      .then((response) => {
  ...
  return (
    <div style={{ 
      ...
      <div style={{ marginBottom: "1rem" }}>
        <label htmlFor="roomName" style={{ color: "#fff", fontSize: "1.5rem", marginBottom: "0.5rem"}}>Room Name: &nbsp;</label>
        <input
          type="text"
          id="roomName"
          value={roomName}
